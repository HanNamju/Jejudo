...
<html lang="ko">
    ...
    <style>
        ...
        #areaSet, #name, #date, #mode-select, #personal, #rtext, #password, #licenseSet {
                ...
                <div class="col-md-5 col-sm-7 bg--white text-center">
                    <div class="pos-vertical-center">
                        ...
                        <div class="text-left">
                            ...
                            <form action="insertTrip.do" method="post" enctype="multipart/form-data" style="max-width: 75%;">
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        ...
                                        <label>여행 제목</label> 
                                            <input type="text" name="trName" id="name" placeholder="여행 제목을 지정해 주세요."/>
                                        </div>
                                    </div>
                                </div>
                                <!-- 일정/모드 row -->
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="input-with-icon">  
                                        <label>모드</label> 
                                            <select name="trMode" id="mode-select">
                                                <option value="">선택</option>
                                ...
                                <div class="row" style="margin-bottom: 0%;">
                                    <div class="col-sm-6">
                                        <div class="input-with-icon">  
                                        <label>지역</label> 
                                            <select name="trAreaSet" id="areaSet" >
                                                <option value="">-선택-</option>
                                        ...
                                        <div class="input-with-icon">
                                            <div class="row">
                                                <div class="col-sm-8">
                                                    <label>인원</label> 
                                                    <div class="input-with-icon">
                                                    <input type="text" name="trPersonnelSet" id="personal" value="0" readonly="readonly"  />                                                                                           
                                                    </div>
                                                </div>
                                                <div class="col-sm-4" id="pmbutton" style="padding-top: 25px;">                                                    
                                                    <button type ="button" class="btn_count" onclick="fnCalCount('p', this);"><span>+</span></button>
                                                    <button type ="button" class="btn_count" onclick="fnCalCount('m', this);"><span>-</span></button>
                                                </div>
                                            </div>  
                                        </div>
                                    </div>
								...
								<div class="row">
                                    <div class="col-sm-4">
                                        <div class="input-with-icon"> 
                                        <label>성별</label> 
                                            <select name="trGenderSet" id="date">
                                                <option value="">-선택-</option>
                                       ...
                                       <div class="col-sm-4">
                                        <div class="input-with-icon">  
                                        <label>이동수단</label> 
                                            <select name="trTransportationSet" id="date">
                                                <option value="">-선택-</option>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="input-with-icon">   
                                         <label>운전면허</label>                                      
                                            <select name="trLicenseSet" id="licenseSet">
                                             <option value="">-선택-</option>
                                             <option value="X">무관</option>                                       
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-12">
                                    <label>여행 소개</label> 
                                    <textarea name="trIntro" id="rtext" cols="15" rows="4" style="border-style: none; border-radius: 20px;" placeholder="여행을 소개해 주세요."></textarea>
                                    </div>
                                </div>
                                <!-- 비밀번호 -->
                                <div class="row">
                                    <div class="col-sm-6">
                                    <label>비밀번호 설정</label> 
                                        <input type="password" name="trPasswordSet" id="password" placeholder="비밀번호"/>
                                    </div>
                                </div>

                                <div class="row">
                                    <div class="col-sm-12">
                                        <button type="submit" class="btn" id="create_btn" style="background-color: rgba(166, 208, 205, 0.8); border-style: none;"><span>create !</span></button>
                                    </div>
                                </div>
                                <div class="row">
