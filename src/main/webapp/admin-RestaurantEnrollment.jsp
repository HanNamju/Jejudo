                            ...
                            <div class="container">
                              <div class="input-form-backgroud row">
                                <div class="input-form col-md-12 mx-auto">
                                  <h2 class="mb-3">식당 등록</h2>
                                  <hr style="background-color: rgba(0, 0, 0, 0.2);"> 
                                   <form action="/insertplace.do" method="post" enctype="multipart/form-data">
                                    <div class="mb-3">
                                    <input type="hidden" id="category" name="pCategory" value="식당">
                                      <label for="name"><h5 style="color: rgba(0, 0, 0, 0.5);">식당명</h4></label>
                                      <input
                                      	name="pName"
                                        type="text"
                                        class="form-control"
                                        id="customer-id"
                                        placeholder="등록하실 식당명을 입력해주세요"
                                        maxlength="12"
                                        required
                                    ...
                                    <div class="mb-3">
                                        <label for="tel"><h5 style="color: rgba(0, 0, 0, 0.5);">식당 전화번호</h5></label>
                                        <input
                                          type="text"
                                          name="pTell"
                                          class="form-control"
                                        ...
                                        <div class="invalid-feedback">전화번호를 입력해주세요.</div>
                                          ...
                                          <div class="mb-3">
                                              <label for="email"><h5 style="color: rgba(0, 0, 0, 0.5);">식당 주소</h5></label>
                                              <input
                                                type="text"
                                                name="pAddress"
                                                class="form-control"
                                        ...
                                        <div class="invalid-feedback">식당주소를 입력해주세요</div>
                                                </div>

                                            <label for="email"><h5 style="color: rgba(0, 0, 0, 0.5);" >식당 정보</h5></label>
                                                <div class="mb-3">
