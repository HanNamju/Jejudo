                              ...
                              <div class="input-form-backgroud row">
                                <div class="input-form col-md-10 mx-auto">
                                 ...
                                 <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        <label for="email"><h5 style="color: rgba(0, 0, 0, 0.5);">전화번호</h5></label>
                                        <input
                                          type="picture"
                                          class="form-control"
                                          id="email"
                                          placeholder="전화번호를 입력해주세요"
                                          value="${getPlace.pTell}"
                                          required
                                          style="border: 1px solid rgba(0, 0, 0, 0.2);"
                                          name="pTell"
                                        />
                                        ...
                                        <div class="invalid-feedback">전화번호를 입력해주세요.</div>
                                          ...
                                          <div class="mb-3">
                                              <label for="email"><h5 style="color: rgba(0, 0, 0, 0.5);"> 주소</h5></label>
                                              <input
                                                type="picture"
                                                class="form-control"
                                                id="email"
                                                value="${getPlace.pAddress}"
                                        ...
                                        <div class="invalid-feedback">주소를 입력해주세요</div>
                                            ...
                                            <label for="email"><h5 style="color: rgba(0, 0, 0, 0.5);" >장소 정보</h5></label>
                                                <div class="mb-3">
                                                <textarea style="border: 1px solid rgba(0, 0, 0, 0.2);"  placeholder="${getPlace.pInfo}"   name="pInfo" id="" cols="50" rows="5"></textarea>
                                    ...
                                    <div class="sign-up-footer row">
                                      <div class="sign-up-footer-items col-md-9 mb-3">
                                          ...
                                          <button type="submit" class="btn btn-success btn-lg btn-block button-custom"
                                            id="red" >수정하기</button>
                                      </div>
